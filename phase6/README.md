# Phase 6: Quantum Interpretability (Saliency Maps)
...
- We compute the gradient of the predicted class probability with respect to the 16 input PCA features: $
abla_{feat} P(y|X)$.
...
```bash
docker run --rm -v $(pwd)/phase6/results:/app/phase6/results quantum-plankton python phase6/quantum_saliency.py
```

## Expected Results
Check the `phase6/results/` directory for:
