...
-3. Optimize binary classifier
In this phase, we set up a hyperparameter sweep on neural architectures. Note that k-class classification is likely impossible with such weak architecture.
...
# Phase Three: Optimize binary classifier
In this phase, we set up a hyperparameter sweep on neural architectures. Note that k-class classification is likely impossible with such weak architecture.
